  ...
  return (
    <div className='login-popover_wrapper' onClick={() => props.closeLogoutPopover()}>
      <div onClick={(e) => e.stopPropagation()} id="login-popover_content-wrapper">
        ...
        <label className="logout-popover_nav-button" style={{margin:'15px', display:'block'}} for="exampleInputEmail1">Go To Dashboard</label>
        <label className="logout-popover_nav-button" style={{margin:'15px', display:'block'}} for="exampleInputEmail1">Update Profile</label>
        <label className="logout-popover_nav-button" style={{margin:'15px', display:'block'}} for="exampleInputEmail1">Update Payment Method</label>
        <label className="logout-popover_nav-button" style={{margin:'15px', display:'block'}} for="exampleInputEmail1">Help & Feedback</label>
          <button 
